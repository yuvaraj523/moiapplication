...
<?php
include('db.php');
$sql = "SELECT * FROM ceremony_moi ORDER BY date DESC";
...
<head>
    ...
    <title> List Ceremony Moi Dashboard</title>
...
?>
    ...
    <form method="POST" action="ceremony_delete_record.php">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        ...
                        <td><?= htmlspecialchars($sno++); ?></td>
                         <td><?php echo htmlspecialchars($row['date']); ?></td>
                            <td><?php echo htmlspecialchars($row['ceremony']); ?></td>
                            <td><?php echo htmlspecialchars($row['ceremonyowner']); ?></td>
                            <td><?php echo htmlspecialchars($row['name']); ?></td>
                            <td><?php echo htmlspecialchars($row['address']); ?></td>
                            <td><?php echo htmlspecialchars($row['mobile']); ?></td>
                            <td><?php echo htmlspecialchars($row['amount']); ?></td>
                            <td class="actions">
                                <a href="ceremony_edit.php?id=<?php echo htmlspecialchars($row['id']); ?>" title="Edit"><i class="fas fa-edit"></i></a>
                                <a href="ceremony_view.php?id=<?php echo htmlspecialchars($row['id']); ?>" title="View"><i class="fas fa-eye"></i></a>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generatePDF() {
       ...
       // Calculate column widths based on content
        ...
        let currentY = 30;
        const cellPadding = 8;
        const columnWidths = headers.map(header => Math.max(header.length * 5.3, 30));
        ...
        rows.forEach(row => {
            ...
            if (currentY > 260) { // Adjust if needed
                doc.addPage();
        ...
        // Save the PDF
        doc.save('ceremonymoi_details.pdf');
    }
...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = `ceremony_delete.php?id=${id}`;
        }
    });
}
